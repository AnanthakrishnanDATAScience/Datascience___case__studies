...
Lowest_salary int(20) not null,
Highest_salary int(20) not null,
...
select A.first_name,A.last_name,B.department_id,B.department_name from employees A inner join departments B on A.department_id=B.department_id ;
/* 2. Write a query in SQL to display the first and last name, department, city, and state province for each employee. */
select A.first_name,A.last_name,A.department_id,B.department_name,C.location_id,C.city,C.state_province from employees A inner join departments B on A.department_id=B.department_id inner join locations C on B.location_id=C.location_id;
/* 3. Write a query in SQL to display the first name, last name, salary, and job grade for all employees. */
select A.first_name,A.last_name,A.salary,B.grade_level from employees A inner join job_grade B on A.salary  between B.lowest_salary and B.highest_salary order by grade_level;
...
select A.first_name,A.last_name,B.department_id,B.department_name from employees A inner join departments B on A.department_id = B.department_id where A.department_id in (80,40);
...
select A.first_name,A.last_name,A.department_id,B.department_name,C.city,C.state_province from employees A inner join departments B on A.department_id = B.department_id inner join locations C on B.location_id=C.location_id where A.first_name like '%z%';
...
select A.first_name,A.last_name,A.salary,A.employee_id from employees A inner join employees B on A.employee_id where A.salary > B.salary and  A.employee_id =182; 
/* 8. Write a query in SQL to display the first name of all employees including the first name of their manager. */
select A.first_name,A.last_name,A.salary,B.job_id,B.job_title from employees A inner join jobs B on A.job_id=B.job_id  where B.job_title like "%manager%";
/* 9. Write a query in SQL to display the department name, city, and state province for each department. */
select A.department_id,A.department_name,B.location_id,B.city,B.state_province from departments A inner join locations B on A.location_id=B.location_id where B.state_province is not null;
...
select A.first_name,A.last_name,B.department_id,B.department_name from employees A left join departments B on A.department_id=B.department_id order by A.department_id desc;
...
select A.first_name as employee_name,B.first_name as manager_name,A.employee_id from employees A left join employees B on A.manager_id=B.employee_id;  
...
select A.first_name,A.last_name,A.department_id from employees A inner join employees B on A.department_id=B.department_id and A.last_name like "%taylor%";
...
select concat(A.first_name,A.last_name),A.department_id,B.department_name,C.start_date from employees A inner join departments B on A.department_id=B.department_id inner join job_history C on A.job_id=C.job_id  where C.start_date between "1993-01-01"and "1997-08-31" order by C.start_date desc;
...
select concat(A.first_name,A.last_name) as full_name,A.salary,B.job_title,B.job_id,B.max_salary-A.salary as difference_salaries from employees A inner join jobs B on A.job_id=B.job_id;   
SELECT j.job_title,
...
select B.department_name,AVG(A.salary) as average_salaries,count(commission_pct) from employees A inner join departments B on A.department_id=B.department_id  group by B.department_name;
...
select concat(A.first_name,A.last_name) as full_name,B.job_title,B.max_salary-A.salary from employees A inner join jobs B on A.job_id=B.job_id where A.department_id=80;
/* 17. Write a query in SQL to display the name of the country, city, and the departments which are running there. */
select A.location_id,B.department_id,B.department_name,A.city,A.state_province from locations A inner join departments B on A.location_id=B.location_id; 
/* 18. Write a query in SQL to display department name and the full name (first and last name) of the manager. */
select concat(A.first_name,A.last_name) as full_name, B.department_name,C.job_title from employees A inner join departments B on A.department_id=B.department_id inner join jobs C on A.job_id=C.job_id where job_title like "%Manager%";
/* 19. Write a query in SQL to display job title and average salary of employees. */
select A.employee_id,B.job_title,Avg(A.salary) as Salary_Averages from employees A inner join jobs B on A.job_id=B.job_id group by B.job_title; 
...
select A.employee_id,A.salary,B.job_title,B.job_id from employees A inner join jobs B on A.job_id = B.job_id where A.salary >=12000 order by A.salary desc;
...
select A.country_name,B.city,C.department_id from countries A inner join locations B on A.country_id=B.country_id inner join departments C on B.location_id=C.location_id ;
/* 22. Write a query in SQL to display the department name, full name (first and last name) of manager, and their city.  */
select concat(first_name,last_name) as full_name,department_name,city from employees A inner join departments B on  A.department_id=B.department_id inner join locations C on B.location_id=C.location_id where job_id like "%MGR%";
...
select A.employee_id,B.job_title,(A.end_date-A.start_date) as no_of_days_worked,A.department_id from job_history A inner join jobs B on A.job_id=B.job_id where A.department_id=80;
...
select first_name,last_name,salary,employee_id from employees where salary>(select salary from employees where employee_id=163) ;
SELECT first_name,
       last_name
  FROM employees
...
select first_name,last_name,Salary,department_id from employees where Salary in (select max(salary) from employees group by department_id);
...
select first_name,last_name,employee_id,salary from employees where Salary in (select salary from employees where first_name like 'Pa%');
select first_name,last_name,employee_id,Salary from employees where manager_id in(select employee_id from employees where first_name like 'Pa%');
SELECT first_name,
       last_name,
       employee_id,
       salary
...
select A.first_name,A.last_name,A.job_id,B.department_name from employees A inner join departments B on A.department_id=B.department_id where department_name like 'Finance%';
...
select * from employees where manager_id=(select employee_id from employees where employee_id in (3000,121));
...
select * from employees where manager_id between (100 and 200) and department_id is  null;
...
select * from (select * from employees order by Salary desc limit 2) as Emp order by salary limit 1;
select * from (select * from  employees order by salary desc limit 4) as EMP order by salary limit 1;
SELECT *
  FROM employees
...
select employee_id,first_name,last_name,Salary,department_id from employees where Salary>(select AVG(salary) from employees) and  first_name like '%j%';
SELECT employee_id,
       first_name,
       last_name,
       salary
...
select concat(first_name,last_name) as employee_name,employee_id from employees where job_id in (select job_title from jobs) and (select location_id from locations where city='Toronto');  
select concat(first_name,last_name) as employee_name,employee_id from employees where department_id in (select department_id from departments where location_id in (select location_id from locations where city='Toronto')); 
...
select employee_id,first_name,last_name from employees where salary < (select salary from employees where job_id in (select job_id from jobs where job_id='MK_MAN'));   
SELECT employee_id,
       first_name,
       last_name,
       job_id
